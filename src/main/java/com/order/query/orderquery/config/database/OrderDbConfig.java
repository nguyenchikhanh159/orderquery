package com.order.query.orderquery.config.database;
...
@EnableJpaRepositories(basePackages = {"com.order.query.orderquery.dao.repository"},
...
public class OrderDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean ordersEntityManagerFactory(@Qualifier("orderDatasource") DataSource ordersDataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(
                "com.order.query.orderquery.dao.entity"
        );
